...
export default function FlightResultCard({
	from = 'Dhaka',
	to = 'New York',
	departing = '2024-01-01',
	returning = '2024-10-10',
	passenger = '1',
}) {
	const randomTime = () => {
		...
		return (
			<div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '10px' }}>
				<h3 className={styles.price}>
					${randomNumberGenerator(min, max)}.00
				</h3>
	...
	return (
		<div className={styles.main}>
			<div className={styles.box1}>
				<Image
					src={airlinesImagesLinks[randomNumberGenerator(0, airlinesImagesLinks.length - 1)]}
					alt="destination"
					width={1250}
					height={420}
				...
				<div className={styles.infoContainer}>
					...
					<div className={styles.icon}>
						<IoAirplaneSharp />
						<small className={styles.small}>Direct flight</small>
					</div>
			...
			<div className={styles.box}>
				<div className={styles.info}>
					<h5>First class</h5>
					{renderPrice({ min: 7000, max: 10000 })}
